export const COPY = {
  en: {
    ...
    catalogEmpty: "No subscriptions yet. New services will appear here after they are added in Admin.",
    month: "1 Month",
    year: "1 Year",
  ...
  ar: {
    ...
    catalogEmpty: "لا توجد اشتراكات بعد. ستظهر الخدمات هنا بعد إضافتها من لوحة المسؤول.",
    month: "شهر واحد",
    year: "سنة واحدة",
